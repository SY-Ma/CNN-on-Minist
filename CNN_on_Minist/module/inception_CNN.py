...
class Inception_CNN(Module):
    ...
    def __init__(self,
        ...
        self.conv1 = nn.Conv2d(in_channels, out_channels=10, kernel_size=3)
        self.inception1 = Inception_block(in_channels=10)

        self.conv2 = nn.Conv2d(in_channels=88, out_channels=20, kernel_size=3)
        self.inception2 = Inception_block(in_channels=20)
