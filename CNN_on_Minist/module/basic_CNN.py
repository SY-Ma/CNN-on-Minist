...
class Basic_CNN(Module):
    ...
    def __init__(self, in_channels: int,
        ...
        self.conv3 = nn.Conv2d(in_channels=32, out_channels=number_of_classes, kernel_size=3, padding=1)
        self.max_pool = nn.MaxPool2d(kernel_size=2)
        self.layer_normal = nn.LayerNorm(90)
        self.linear = nn.Linear(90, number_of_classes)
